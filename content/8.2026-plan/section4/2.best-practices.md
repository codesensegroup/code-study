...
pageTitle: "Section 4 - 12 個最佳實踐重點"
...
4. **Plan → Review → Execute** — 官方 4 階段：Explore → Plan → Implement → Commit
5. **小步驟 + 持續測試** — 從「Verify its work」推導的實作習慣
6. **把 Claude 當資深工程師問** — onboarding 與 codebase 探索的最佳用法
7. **Agent 思維，不是 Copilot** — 描述目標、讓它自己想辦法
8. **Parallel Sessions** — worktree / 多 terminal 擴大產出
11. **避開五大失敗模式** — Kitchen Sink / Over-correct / Over-spec CLAUDE.md / Trust-then-verify gap / Infinite Exploration

**⚙️ 配置環境（讓上面所有事情變容易）**

9. **完整環境配置** — CLAUDE.md / Permissions / CLI tools / MCP / Hooks / Skills / Subagents / Plugins
